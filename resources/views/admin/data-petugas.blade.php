...
@section('container')
    <div class="px-3 py-6 md:p-6 mb-5">
        ...
        <div class="text-gray-600 text-sm">Administrator petugas E-Absen Asrama Polbangtan-mlg</div>
        ...
        <div class="bg-white rounded-lg p-3 mt-5 border-2">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-4">
                <div class="">
                    ...
                    <div class="text-gray-600 text-sm mt-2">Berikut daftar petugas Asrama Polbangtan-mlg</div>
                </div>
                <div class="mt-5 md:mt-0">
                    <a href="{{ route('admin.createPetugasShow') }}"
                        class="bg-utama hover:bg-teal-800 text-white rounded-lg px-3 py-2 text-sm">
                            ...
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-1">
                                        @if (auth()->user()->role_id == 1 || (auth()->user()->role_id == 2 && auth()->user()->id == $user->id))
